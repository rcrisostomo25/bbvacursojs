...
class Equipo {
	constructor(entrenador, indice) {
		...
		this._nombre = generarNombreEquipoPorPosicion(indice);
		this._puntaje = 0;
	}
...
class Torneo {
	...
	resultadosTorneo() {
		...
		for(let e2=0; e2<this._equipos.length; e2++) {
			var equipo2 = this._equipos[e2];
			console.log("  * " + equipo2._nombre+ "; Puntaje: " + equipo2._puntaje+ "; PartidosGanados: " + equipo2._partidosGanamos);
		}
	}
} 
